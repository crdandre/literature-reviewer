from literature_reviewer.components.model_interaction.llm_call import LLMInterface
...
def main():
    ...
    llm_interface = LLMInterface(prompt_framework, model)
    ...
    try:
        response = llm_interface.entry_call(system_prompt, task_prompt)
        print("\nLLM Response:")
        print(response)
